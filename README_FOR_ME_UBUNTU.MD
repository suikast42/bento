...
```shell
 ...
 packer build -only="vmware-iso.vm"  -var "disk_size=16384" -var="disk_type_id=0"   -var="disk_type_id=0"  -var-file="os_pkrvars/ubuntu/ubuntu-26.04-x86_64.pkrvars.hcl" ./packer_templates
```
